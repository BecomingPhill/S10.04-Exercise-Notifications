...
private static final int WEATHER_SYNC_NOTIFICATION_ID = 1348;
...
//          TODO (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            notificationManager.notify(WEATHER_SYNC_NOTIFICATION_ID, builder.build());

//          TODO (8) Save the time at which the notification occurred using SunshinePreferences
            //String lasttime = String.valueOf(Calendar.getInstance().getTime());
            long currentTime = Calendar.getInstance().getTimeInMillis();
           // String LAST_TIME_TAG = "last_notification_time";
           // PreferenceManager.getDefaultSharedPreferences(context).edit().putString(LAST_TIME_TAG, lasttime).apply();
            SunshinePreferences.saveLastNotificationTime(context,currentTime);
